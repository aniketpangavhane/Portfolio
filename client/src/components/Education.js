  ...
  const certifications = [
    {
      ...
      issuer: "HackerRank",
      date: "2026",
      description: "Validated intermediate-level proficiency in Node.js including backend development, REST API creation, asynchronous programming, and server-side performance optimization.",
      skills: [
      "Node.js",
      "Express.js",
              ...
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    {cert.link && (
                      <a 
                        href={'https://www.hackerrank.com/certificates/f83909286421'}
